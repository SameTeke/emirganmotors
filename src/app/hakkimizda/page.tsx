      ...
      <section className="mx-auto flex max-w-screen-2xl flex-col gap-10 px-4 py-12 sm:px-6 lg:px-12">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-slate-600">
            Borusan Otomotiv Grubu&apos;nun çoklu marka ve kanal stratejisi vizyonuyla hayata geçirilen Borusan Next.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_2.1fr]">
          ...
          <article className="prose prose-slate max-w-none">
            <p>
              Borusan Otomotiv Grubu&apos;nun çoklu marka ve kanal stratejisi vizyonuyla hayata geçirilmiş olan Borusan
              Next; kendi lokasyonlarında güven, hız ve müşteri deneyimi odaklı bir anlayışla belirlenen kriterlere uygun
            ...
            <p>
              ...
              düzeye çıkarmayı amaçlayan Borusan Next, iletişim merkezi ile haftanın 7 günü boyunca, 08.00-18.00
              saatleri arasında kesintisiz hizmet verir.
            </p>
            <p>
              Nakit alım, takas ve satış hizmetlerinin yanı sıra Borusan Next Servis ile İstanbul&apos;da Kağıthane ve
            ...
            <p>
              2.el araba arayanlar için güvenilir adres olmaya devam eden Borusan Next, aynı zamanda tamamen ekspertizli
