...
export type Step3State = Record<string, number | string | boolean | undefined>;
export type Step3Errors = Record<string, string | undefined>;
...
function CarSvg({ statuses }: { statuses: Step3State }) {
  ...
  const overlays = [
    { id: 'B0101', x: 52, y: 132, width: 40, height: 88, rx: 8 }, // Sol Ön Çamurluk
    { id: 'B0201', x: 237, y: 132, width: 40, height: 88, rx: 8 }, // Sağ Ön Çamurluk
    { id: 'B0301', x: 95, y: 150, width: 55, height: 92, rx: 8 }, // Sol Ön Kapı
    { id: 'B0401', x: 179, y: 150, width: 55, height: 92, rx: 8 }, // Sağ Ön Kapı
    { id: 'B0501', x: 95, y: 214, width: 55, height: 88, rx: 8 }, // Sol Arka Kapı
    { id: 'B0601', x: 179, y: 214, width: 55, height: 88, rx: 8 }, // Sağ Arka Kapı
    { id: 'B0701', x: 52, y: 222, width: 40, height: 90, rx: 8 }, // Sol Arka Çamurluk
    { id: 'B0801', x: 237, y: 222, width: 40, height: 90, rx: 8 }, // Sağ Arka Çamurluk
    { id: 'B0901', x: 114, y: 242, width: 102, height: 42, rx: 10 }, // Motor Kaputu
    { id: 'B1001', x: 114, y: 78, width: 102, height: 42, rx: 10 }, // Bagaj
    { id: 'B1101', x: 98, y: 118, width: 134, height: 120, rx: 12 }, // Tavan
    { id: 'B1201', x: 124, y: 292, width: 88, height: 26, rx: 8 }, // Ön Tampon
    { id: 'B1301', x: 124, y: 20, width: 88, height: 24, rx: 8 } // Arka Tampon
  ];

  // Uses background svg image and overlays colored regions with ids matching parts
  return (
    <svg
      viewBox="0 0 329 340"
      className="w-full max-w-sm"
      xmlns="http://www.w3.org/2000/svg"
      aria-label="Kaporta görseli"
    >
...
export default function Step3({ value, errors, onChange, onPrev, onNext }: Props) {
